...
interface IUserAccountManager  { 
    ...
    function grantSpenderRole(IProvince _province) external;
    function grantTemporaryMinterRole(IProvince _province) external;
    function revokeTemporaryMinterRole(IProvince _province) external; 
