...
library ResourceFactorExtensions {
    ...
    function calculateCost(ResourceFactor memory _cost, uint256 _multiplier, uint256 _rounds, BaseSettings memory _baseSettings) internal pure returns (ResourceFactor memory result) {
        ...
        result.manPowerAttrition = ((result.manPower * result.attrition) / _baseSettings.baseUnit); // The _cost in manPowerAttrition
    ...
    function getRewardPart(ResourceFactor memory self, uint256 _fee) internal pure returns (ResourceFactor memory _result) {
    ...
    function getRestReward(ResourceFactor memory self, ResourceFactor memory _spend) internal pure returns (ResourceFactor memory _result) {
